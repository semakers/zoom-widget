            ...
            if(widget.centerOnScale){
              if(portrait){
                if(widget.height*scale < constraints.maxHeight){
                  centerTop =
                          (constraints.maxHeight - widget.height * scale) / 2;
                }
              }else{
                if(widget.width*scale < constraints.maxWidth){
                  centerLeft =
                          (constraints.maxWidth - widget.width * scale) / 2;
                }
              }
            }
        }
                ...
                children: <Widget>[
                  ...
                  Positioned(
                    ...
                    left: -(auxLeft + localLeft + centerLeft + scaleLeft) /
                        ((widget.width * scale) / constraints.maxWidth),
                    child: Opacity(
                      opacity: (widget.width * scale <= constraints.maxWidth || !widget.enableScroll)
                          ? 0
                  ...
                  Positioned(
                    ...
                    child: Opacity(
                      opacity: (widget.height * scale <= constraints.maxHeight || !widget.enableScroll)
                          ? 0
                          :widget.opacityScrollBars,
                      child: Container(
